...
export default function DashboardPage() {
  const [queueData, setQueueData] = useState<SessionData>({
    usersInQueue: 0,
    lastSession: "None",
  });
    ...
    <div className="dashboard-container">
      <div className="dashboard-card-row">
        <DashboardCard
          ...
          icon={
            <img
              src="/icons/currentQueueStatus.svg"
              alt="Users"
